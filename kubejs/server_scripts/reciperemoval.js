ServerEvents.recipes(event => {
    ...
    let toRemove = [
        ...
        {output: 'plushies:bat_plushie'},
        {output: 'practical_plushies_animals:axolotl_plushie'},
        {output: 'plushies:dragon_plushie'},
        {output: 'practical_plushies_animals:bee_plushie'},
        {output: 'plushies:drowned_plushie'},
        {output: 'practical_plushies_animals:cow_plushie'},
        {output: 'practical_plushies_animals:parrot_plushie'},
        {output: 'practical_plushies_animals:pig_plushie'},
        {output: 'practical_plushies_animals:sheep_plushie'},
        {output: 'practical_plushies_animals:frog_plushie'},
        {output: 'practical_plushies_animals:cat_plushie'},
        {output: 'practical_plushies_animals:sniffer_plushie'},
        {output: 'practical_plushies_mobs:wither_skeleton_plushie'},
        {output: 'practical_plushies_mobs:skeleton_plushie'},
        {output: 'practical_plushies_mobs:enderman_plushie'},
        {output: 'practical_plushies_mobs:creeper_plushie'},
        {output: 'practical_plushies_mobs:zombie_plushie'},
