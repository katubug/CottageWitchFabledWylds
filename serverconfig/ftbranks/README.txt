...
Last README file update: Mon Feb 12 15:18:13 CST 2024
...
command.back
command.backup
command.backup.create-file-remote
command.backup.create-file-remote.file-path
command.backup.delete
command.backup.delete.snapshot
command.backup.full
command.backup.gc
command.backup.help
command.backup.help.subcommand
command.backup.info
command.backup.init
command.backup.list
command.backup.local
command.backup.prune
command.backup.push
command.backup.push.snapshot-date
command.backup.remote-delete
command.backup.remote-delete.snapshot
command.backup.remote-list
command.backup.remote-prune
command.backup.remote-restore
command.backup.remote-restore.snapshot
command.backup.restore
command.backup.restore.snapshot
command.backup.set
command.backup.set.autoback-action
command.backup.set.autoback-action.full
command.backup.set.autoback-action.full-gc
command.backup.set.autoback-action.local
command.backup.set.autoback-action.none
command.backup.set.autoback-wait
command.backup.set.autoback-wait.minutes
command.backup.set.backup-enabled
command.backup.set.backup-enabled.false
command.backup.set.backup-enabled.true
command.backup.set.broadcast-enabled
command.backup.set.broadcast-enabled.false
command.backup.set.broadcast-enabled.true
command.backup.set.broadcast-message
command.backup.set.broadcast-message.message
command.backup.set.force-debug-enabled
command.backup.set.force-debug-enabled.false
command.backup.set.force-debug-enabled.true
command.backup.set.lock-cleanup-enabled
command.backup.set.lock-cleanup-enabled.false
command.backup.set.lock-cleanup-enabled.true
command.backup.set.mods-backup-enabled
command.backup.set.mods-backup-enabled.false
command.backup.set.mods-backup-enabled.true
command.backup.set.native-git-enabled
command.backup.set.native-git-enabled.false
command.backup.set.native-git-enabled.true
command.backup.set.remote-retention-policy
command.backup.set.remote-retention-policy.all
command.backup.set.remote-retention-policy.daily
command.backup.set.remote-retention-policy.daily.gracePeriodDays
command.backup.set.remote-retention-policy.fixed
command.backup.set.remote-retention-policy.fixed.count
command.backup.set.remote-retention-policy.gfs
command.backup.set.remote-url
command.backup.set.remote-url.url
command.backup.set.restore-directory
command.backup.set.restore-directory.full-directory-path
command.backup.set.retention-policy
command.backup.set.retention-policy.all
command.backup.set.retention-policy.daily
command.backup.set.retention-policy.daily.gracePeriodDays
command.backup.set.retention-policy.fixed
command.backup.set.retention-policy.fixed.count
command.backup.set.retention-policy.gfs
command.backup.set.shutdown-action
command.backup.set.shutdown-action.full
command.backup.set.shutdown-action.full-gc
command.backup.set.shutdown-action.local
command.backup.set.shutdown-action.none
command.bettertags
...
command.capsule
command.capsule.downloadTemplate
command.capsule.exportHeldItem
command.capsule.exportSeenBlock
command.capsule.fromExistingReward
command.capsule.fromExistingReward.rewardTemplateName
command.capsule.fromExistingReward.rewardTemplateName.target
command.capsule.fromHeldCapsule
command.capsule.fromHeldCapsule.outputTemplateName
command.capsule.fromStructure
command.capsule.fromStructure.rewardTemplateName
command.capsule.fromStructure.rewardTemplateName.target
command.capsule.giveBlueprint
command.capsule.giveBlueprint.rewardTemplateName
command.capsule.giveBlueprint.rewardTemplateName.target
command.capsule.giveEmpty
command.capsule.giveEmpty.size
command.capsule.giveEmpty.size.overpowered
command.capsule.giveLinked
command.capsule.giveLinked.rewardTemplateName
command.capsule.giveLinked.rewardTemplateName.target
command.capsule.giveLinked.rewardTemplateName.target.withRecall
command.capsule.giveRandomLoot
command.capsule.giveRandomLoot.target
command.capsule.help
command.capsule.reloadLootList
command.capsule.reloadWhitelist
command.capsule.setAuthor
command.capsule.setAuthor.authorName
command.capsule.setBaseColor
command.capsule.setBaseColor.color
command.capsule.setMaterialColor
command.capsule.setMaterialColor.color
command.capsule.setYOffset
command.capsule.setYOffset.yOffset
command.carryon
...
command.effect.lockdown
command.effect.lockdown.targets
command.effect.lockdown.targets.effect
command.effect.lockdown.targets.effect.duration
command.effect.lockdown.targets.effect.duration.hideParticles
command.enchant
...
command.exposure.show.exposure
command.exposure.show.exposure.id
command.exposure.show.exposure.id.negative
...
command.god.player
command.hat
command.hauntedharvest
command.hauntedharvest.copycarving
command.heal
command.heal.player
command.help
...
command.mobScalings.set.entity_type.scaling_type.min_scaling
command.mobScalings.set.entity_type.scaling_type.min_scaling.max_scaling
...
command.reload
command.remorphed
command.remorphed.addShape
command.remorphed.addShape.player
command.remorphed.addShape.player.shape
command.remorphed.addShape.player.shape.nbt
command.remorphed.clearShapes
command.remorphed.clearShapes.player
command.remorphed.hasShape
command.remorphed.hasShape.player
command.remorphed.hasShape.player.shape
command.remorphed.hasShape.player.shape.nbt
command.remorphed.removeShape
command.remorphed.removeShape.player
command.remorphed.removeShape.player.shape
command.remorphed.removeShape.player.shape.nbt
command.return
...
command.walkers
command.walkers.change2ndShape
command.walkers.change2ndShape.player
command.walkers.change2ndShape.player.shape
command.walkers.change2ndShape.player.shape.nbt
command.walkers.change2ndShape.shape
command.walkers.change2ndShape.shape.nbt
command.walkers.remove2ndShape
command.walkers.remove2ndShape.player
command.walkers.show2ndShape
command.walkers.show2ndShape.player
command.walkers.switchShape
command.walkers.switchShape.player
command.walkers.switchShape.player.shape
command.walkers.switchShape.player.shape.nbt
command.walkers.switchShape.shape
command.walkers.switchShape.shape.nbt
command.wares
command.wares.debug
command.wares.debug.completeAgreement
command.wares.debug.runTests
command.wares.give
command.wares.give.agreementExample
command.wares.give.sealedAgreementExample
command.warp
command.warp.name
command.weather
